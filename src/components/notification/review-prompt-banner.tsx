...
export function ReviewPromptBanner({ dueCount, newDue, reviewDue, newQueued, onStartReview, onDismiss }: ReviewPromptBannerProps) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-2">
      <div className="flex items-center gap-3 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 dark:border-amber-800 dark:bg-amber-950/50">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg bg-amber-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-amber-700 transition-colors dark:bg-amber-700 dark:hover:bg-amber-600"
          >
          ...
          <button
            onClick={onDismiss}
            className="inline-flex items-center justify-center rounded-lg p-1.5 text-amber-500 hover:text-amber-700 hover:bg-amber-100 transition-colors dark:text-amber-400 dark:hover:text-amber-300 dark:hover:bg-amber-900"
            title="暂时忽略"
          >

...
**写文件的方式是标记块，不是工具调用。系统中没有 file-write / file-edit 工具，不要尝试调用。**
...
| **写入/创建文件** | ❌ 无工具 | **标记块** <<<file-write:...>>> |
| **插入代码** | ❌ 无工具 | **标记块** <<<file-edit:...:insert:...>>> |
| **替换代码** | ❌ 无工具 | **标记块** <<<file-edit:...:replace:...>>> |
...
- **不要尝试调用 file-write / file-edit 工具，这些工具不存在。写文件只能用标记块。**
